...
<div class="row">
  <div class="col-md-12">
    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#add_admin">Add New Admin</button>
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <td>{{ $item->email }}</td>
        <td>
          <button class="bi bi-trash" onclick="deleteAdmin({{ $item->id }})"> Delete</button>
        </td>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <div class="container">
              <div class="mb-5">
                  <form enctype="multipart/form-data" id="add_admin_form">
                    ...
                    <div class="form-group mt-3">
                      <label for="desc" class="form-label">Role</label>
