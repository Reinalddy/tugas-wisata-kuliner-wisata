    ...
    display: none !important;
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="{{ url("/storage/$kuliner->image_path") }}" alt="..." /></div>
                    <div class="col-md-6">
        ...
        <section class="py-5 bg-light">
            <div class="container mt-5">
                <h2 class="fw-bolder mb-4">Rekomendasi kuliner Lainnya</h2>
                  <div class="row" id="kuliner-list">
                    @foreach ($kuliner_all as $item)
