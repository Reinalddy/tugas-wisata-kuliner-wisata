    ...
    display: none !important;
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="{{ url("/storage/$wisata->image_path") }}" alt="..." /></div>
                    <div class="col-md-6">
        ...
        <section class="py-5 bg-light">
            <div class="container mt-5">
                <h2 class="fw-bolder mb-4">Rekomendasi Wisata Lainnya</h2>
                          ...
                          <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                              <div class="card text-white card-has-bg click-col" style="background-image:url('{{ url("/storage/$item->image_path") }}');">
                                  <div class="card-img-overlay d-flex flex-column">
                                      <div class="card-body">
                                      <a href="{{ url("/wisata/$item->id") }}" style="text-decoration: none; color:white;"><h1>{{ $item->name }}</h1></a>
